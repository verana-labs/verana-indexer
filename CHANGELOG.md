...
* acknowledge processed subscribe on both WebSocket channels ([#410](https://github.com/verana-labs/verana-indexer/issues/410)) ([a4647a9](https://github.com/verana-labs/verana-indexer/commit/a4647a9a44a31eb81cdb55be8cfe41fc2aae1ada))
...
* blockTime on the subscribed acknowledgement ([#416](https://github.com/verana-labs/verana-indexer/issues/416)) ([04e68e7](https://github.com/verana-labs/verana-indexer/commit/04e68e745b5b67052647869d4f1dbd84b0dd1f04))
* complete ecsCredentials entries (id, digestJCS, issuedAtTime) ([#387](https://github.com/verana-labs/verana-indexer/issues/387)) ([6f9704a](https://github.com/verana-labs/verana-indexer/commit/6f9704aa4056bc92685558353015f4535117e6f3))
* consume expiresAtTime from verre 0.4.0 via IRegistryAdapter ([#383](https://github.com/verana-labs/verana-indexer/issues/383)) ([e488454](https://github.com/verana-labs/verana-indexer/commit/e488454700974cd64ed3a039ae93f95b776386de))
...
* corporation-typed participant filter on ecosystem and schema lists ([#401](https://github.com/verana-labs/verana-indexer/issues/401)) ([c2b293a](https://github.com/verana-labs/verana-indexer/commit/c2b293a572650b419c66e01345d486983b6088b1))
* **de:** expose the delegation checkpoint height on the authorization queries ([#427](https://github.com/verana-labs/verana-indexer/issues/427)) ([5e93984](https://github.com/verana-labs/verana-indexer/commit/5e93984d1c59bd9fb8c1948757f67761bfe3afbd))
* **de:** implement IDX-DE-QRY-5 list fee grants ([#396](https://github.com/verana-labs/verana-indexer/issues/396)) ([2c9c289](https://github.com/verana-labs/verana-indexer/commit/2c9c28916eb2dd32be683bfa2a436572165f61ec))
* ecosystem_id on participant responses and list filter (IDX-PP-QRY-1/2) ([#398](https://github.com/verana-labs/verana-indexer/issues/398)) ([78ed393](https://github.com/verana-labs/verana-indexer/commit/78ed393e9ebb091eab54c542a6cd027ac65b538c))
* group module for Corporation-anchored x/group state (IDX-GR-QRY-1..5) ([#403](https://github.com/verana-labs/verana-indexer/issues/403)) ([adb2cb9](https://github.com/verana-labs/verana-indexer/commit/adb2cb99a3658dee8dafce80c373d410a7e992c5))
...
* normalize credential schema history storage ([#417](https://github.com/verana-labs/verana-indexer/issues/417)) ([af7a451](https://github.com/verana-labs/verana-indexer/commit/af7a451c7b90c19518c28086457464c4f75768fd))
...
* policy_address filter on list corporations (IDX-CO-QRY-2) ([#397](https://github.com/verana-labs/verana-indexer/issues/397)) ([53421cd](https://github.com/verana-labs/verana-indexer/commit/53421cdfe92353783be0e03485f406259ad3bf17))
...
* scope pending flat by corporation_id (IDX-PP-QRY-5) ([#399](https://github.com/verana-labs/verana-indexer/issues/399)) ([0fb66c8](https://github.com/verana-labs/verana-indexer/commit/0fb66c8f58e2cdf27b1884d2ad8eac19f322f140))
...
* **stats:** add GET /v4/stats/snapshot and ecosystem metric columns ([#433](https://github.com/verana-labs/verana-indexer/issues/433)) ([306d3dc](https://github.com/verana-labs/verana-indexer/commit/306d3dc6dabecb9a7ac1ed17f6ebe27c5d4dc439))
* support DI proofs ([#429](https://github.com/verana-labs/verana-indexer/issues/429)) ([e9935c9](https://github.com/verana-labs/verana-indexer/commit/e9935c937667d51b4faca1e7bb7ca771186feba5))
...
* wire trust evaluation to verre 0.4.0 ([#404](https://github.com/verana-labs/verana-indexer/issues/404)) ([5b71135](https://github.com/verana-labs/verana-indexer/commit/5b71135b594dc8d76c4267ae33f239a11cc70559))
...
* align the v4 resolve response with the spec ([#424](https://github.com/verana-labs/verana-indexer/issues/424)) ([19779a2](https://github.com/verana-labs/verana-indexer/commit/19779a227824373005b5725f6e03d13783491f74))
* anchor participant_state evaluation to block time instead of wall clock ([#409](https://github.com/verana-labs/verana-indexer/issues/409)) ([c8bd477](https://github.com/verana-labs/verana-indexer/commit/c8bd477d12dcf1945af76cd759d2d7a3b71de71d))
...
* **co:** activate GF versions from chain events to prevent EGF wedge ([#422](https://github.com/verana-labs/verana-indexer/issues/422)) ([9847240](https://github.com/verana-labs/verana-indexer/commit/98472402e1f2dab03738266d2d76dd397e0d0e35))
...
* **de:** delete the authorization row when the chain reports it NotFound ([#430](https://github.com/verana-labs/verana-indexer/issues/430)) ([c96cc39](https://github.com/verana-labs/verana-indexer/commit/c96cc391a5c76f0f8d3f54df94b30eed0e54d3f3))
* **de:** honour period in only_active on operator and VS-operator lists ([#434](https://github.com/verana-labs/verana-indexer/issues/434)) ([38bd469](https://github.com/verana-labs/verana-indexer/commit/38bd469bb6bebfd8d4ed680db3f4a2270093b76b))
...
* drop FeeGrant fields from OperatorAuthorization responses (IDX-DE-QRY-1/3) ([#400](https://github.com/verana-labs/verana-indexer/issues/400)) ([564f3ea](https://github.com/verana-labs/verana-indexer/commit/564f3ea49dd3469b4babbb45fb983010e8c55754))
...
* **feegrant:** handle set_feegrant events from group-executed grants ([#426](https://github.com/verana-labs/verana-indexer/issues/426)) ([b6dd673](https://github.com/verana-labs/verana-indexer/commit/b6dd673816a4a1b5b40bee49185ab76df4927495))
* filter listParticipants by effective range for when ([#382](https://github.com/verana-labs/verana-indexer/issues/382)) ([97ec5f7](https://github.com/verana-labs/verana-indexer/commit/97ec5f7ec441a90f93adf7c76ef80acd3c9843fe))
...
* include resolve corporation object only when the DID is the Corporation's own ([#423](https://github.com/verana-labs/verana-indexer/issues/423)) ([a340fba](https://github.com/verana-labs/verana-indexer/commit/a340fba1c890f8aa35f94f09ff5cb8d5958b361c))
...
* make find beneficiaries participant ids conditional ([#402](https://github.com/verana-labs/verana-indexer/issues/402)) ([a7e4754](https://github.com/verana-labs/verana-indexer/commit/a7e475466878384dc6dd33a40ca71127efc44120))
...
* parse colon-form vpr schema refs in the registry adapter ([#375](https://github.com/verana-labs/verana-indexer/issues/375)) ([21e1c63](https://github.com/verana-labs/verana-indexer/commit/21e1c6332526967484386dce4efa2cc4368ad86b))
* participant events carry the participant DID and corporation id ([#380](https://github.com/verana-labs/verana-indexer/issues/380)) ([8946db8](https://github.com/verana-labs/verana-indexer/commit/8946db84f9818fc55ea6084de7bb7a9259ffc77d))
* persisted trust core idx vt eval 5 ([#377](https://github.com/verana-labs/verana-indexer/issues/377)) ([cc7ea97](https://github.com/verana-labs/verana-indexer/commit/cc7ea97ac1dcdd22a51b07712111e5b02d62e8c6))
* raise default DB storage to 20Gi and add storage sizing docs ([#419](https://github.com/verana-labs/verana-indexer/issues/419)) ([fa04a03](https://github.com/verana-labs/verana-indexer/commit/fa04a03fe96daa1231bcfd69efac8f24631e4558))
* re evaluation triggers ([#373](https://github.com/verana-labs/verana-indexer/issues/373)) ([9692c4c](https://github.com/verana-labs/verana-indexer/commit/9692c4c2a9f3f39a0077f8eb19030795bbb1dcf3))
* re-run build ([690b978](https://github.com/verana-labs/verana-indexer/commit/690b9785570049e2c937719c78eb569095d3f800))
...
* replace the trust evaluation ttl by expiresAtTime ([#371](https://github.com/verana-labs/verana-indexer/issues/371)) ([f7f1580](https://github.com/verana-labs/verana-indexer/commit/f7f1580b811a5cacd13b64b759e3f3c3e6eb5248))
...
* stop overwriting ledger op_state and derive ACTIVE without effective_from ([#406](https://github.com/verana-labs/verana-indexer/issues/406)) ([acf7aca](https://github.com/verana-labs/verana-indexer/commit/acf7aca0eca3ac01ba0cb93b9fcc566140829a0f))
...
* update verre version ([#414](https://github.com/verana-labs/verana-indexer/issues/414)) ([7c55511](https://github.com/verana-labs/verana-indexer/commit/7c555110b6b6415244f0ac0a7179b322cfe0696f))
...
* upgrade verre to 0.4.1 dev version ([#413](https://github.com/verana-labs/verana-indexer/issues/413)) ([3a3cecd](https://github.com/verana-labs/verana-indexer/commit/3a3cecd9d69defe411dca41a5ee16e99309e0ff9))

...
import { Block, BlockCheckpoint, Event, EventAttribute, Proposal, Transaction } from '../../../../src/models'
...
export default class CrawlProposalTest {
  ...
  async initSuite() {
    ...
    jest
      .spyOn(Proposal, 'getProposerBySearchTx')
      .mockResolvedValue(['verana1qwexv7c6sm95lwhzn9027vyu2ccneaqa7c24zk', [{ denom: 'utaura', amount: '100000' }]])

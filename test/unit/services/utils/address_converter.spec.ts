...
import { convertBech32AddressToEthAddress, convertEthAddressToBech32Address } from '../../../../src/services/evm/utils'
...
export default class TestAddressConverterService {
  ...
  public testConvertEthAddressToBech32Address() {
    ...
    expect(evmosAddress).toEqual('evmos1dvggkfyuzaeefllm0256e9dyu2t0943l9k55cf')

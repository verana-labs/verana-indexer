...
jest.mock('../../../../src/modules/pp-height-sync/pp_height_sync_helpers', () => {
  const actual = jest.requireActual('../../../../src/modules/pp-height-sync/pp_height_sync_helpers')
  return {
    __esModule: true,
    ...actual,
...
describe('🧪 ParticipantProcessorService', () => {
  ...
  it('✅ should return participant for getParticipant', async () => {
    const res = await broker.call(`v1.${SERVICE.V1.ParticipantProcessorService.key}.getParticipant`, {
      schema_id: 123,
      grantee: 'wallet123',
      type: 'root',
    })
  ...
  it('✅ should list participants for listParticipants', async () => {
    const res = await broker.call(`v1.${SERVICE.V1.ParticipantProcessorService.key}.listParticipants`, {
      schema_id: 123,
      grantee: 'wallet123',
      type: 'root',
    })

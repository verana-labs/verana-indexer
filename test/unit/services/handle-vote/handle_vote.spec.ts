...
import { Block, BlockCheckpoint, Transaction, Vote } from '../../../../src/models'
...
export default class HandleTxVoteServiceTest {
  ...
  @BeforeEach()
  async initSuite() {
    this.handleVoteTxService = this.broker.createService(HandleTxVoteService) as HandleTxVoteService

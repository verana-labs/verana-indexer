...
import { getAllEvent, insertFakeEventWithInputId } from '../../mock-data/event.mock'
...
export default class MigrateDateEventTableSpec {
  ...
  async initSuite() {
    ...
    this.migrateDataEventTableJob = this.broker.createService(MigrateDataEventTableJob) as MigrateDataEventTableJob
    ...
    await knex.raw('TRUNCATE TABLE block, transaction, event, block_checkpoint RESTART IDENTITY CASCADE')
  }

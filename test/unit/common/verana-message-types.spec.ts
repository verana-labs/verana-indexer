...
describe('verana-message-types', () => {
  describe('Message Type Enums', () => {
    ...
    it('should have correct VeranaDelegationMessageTypes values', () => {
      expect(VeranaDelegationMessageTypes.GrantOperatorAuthorization).toBe(
        '/verana.de.v1.MsgGrantOperatorAuthorization'
      )
      expect(VeranaDelegationMessageTypes.RevokeOperatorAuthorization).toBe(
    ...
    it('should have correct VeranaGovernanceFrameworkMessageTypes values', () => {
      expect(VeranaGovernanceFrameworkMessageTypes.AddGovernanceFrameworkDocument).toBe(
        '/verana.gf.v1.MsgAddGovernanceFrameworkDocument'
      )
      expect(VeranaGovernanceFrameworkMessageTypes.IncreaseActiveGovernanceFrameworkVersion).toBe(
  ...
  describe('Message Type Checkers', () => {
    ...
    it('isGovernanceFrameworkMessageType should work correctly', () => {
      expect(
        isGovernanceFrameworkMessageType(VeranaGovernanceFrameworkMessageTypes.AddGovernanceFrameworkDocument)
      ).toBe(true)

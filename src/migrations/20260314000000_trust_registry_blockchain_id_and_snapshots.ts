...
export async function up(knex: Knex): Promise<void> {
  ...
  await knex.raw('CREATE INDEX IF NOT EXISTS idx_tr_snapshot_tr_height ON trust_registry_snapshot (tr_id, height DESC)')
  await knex.raw(
  ...
  const addColumnIfMissing = async (tableName: string, columnName: string, bigint: boolean): Promise<void> => {

...
export async function up(knex: Knex): Promise<void> {
  ...
  if (!hasRetryTable) {
    ...
    try {
      ...
      console.warn(
        'Failed to create index trust_reattemptable_last_retry_idx; this may impact performance of trust result refreshing.'
      )
    }
  }
}
...
export async function down(knex: Knex): Promise<void> {
  ...
  try {
    ...
    console.warn(
      'Failed to drop index trust_reattemptable_last_retry_idx; this may impact performance of trust result refreshing.'
    )
  }

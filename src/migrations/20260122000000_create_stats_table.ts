...
export async function up(knex: Knex): Promise<void> {
  await knex.schema.createTable('stats', (table) => {
    ...
    table.bigInteger('cumulative_active_ecosystems').defaultTo(0).notNullable()
    table.bigInteger('cumulative_archived_ecosystems').defaultTo(0).notNullable()
    ...
    table.bigInteger('delta_active_ecosystems').defaultTo(0).notNullable()
    table.bigInteger('delta_archived_ecosystems').defaultTo(0).notNullable()

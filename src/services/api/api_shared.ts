...
export function isUnknownMessageError(errorMessage: string): boolean {
  ...
  return errorMessage.includes('Unknown Verana message types') || errorMessage.includes('UNKNOWN VERANA MESSAGE TYPES')
}
...
export function parseCorporationId(raw: unknown): { ok: true; value: number | null } | { ok: false; error: string } {

  ...
  async syncFromLedger(
    ...
    try {
      ...
      const payload: Record<string, unknown> = {
        ...
        issuer_grantor_validation_validity_period: Number(schema.issuer_grantor_validation_validity_period ?? schema.issuerGrantorValidationValidityPeriod ?? 0),
        verifier_grantor_validation_validity_period: Number(schema.verifier_grantor_validation_validity_period ?? schema.verifierGrantorValidationValidityPeriod ?? 0),
        issuer_validation_validity_period: Number(schema.issuer_validation_validity_period ?? schema.issuerValidationValidityPeriod ?? 0),
        verifier_validation_validity_period: Number(schema.verifier_validation_validity_period ?? schema.verifierValidationValidityPeriod ?? 0),
        holder_validation_validity_period: Number(schema.holder_validation_validity_period ?? schema.holderValidationValidityPeriod ?? 0),

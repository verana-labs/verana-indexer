 ...
 *    To overwrite a nested parameter, e.g. retryPolicy.retries,
 *    use `RETRYPOLICY_RETRIES=10` env var.
 *
...
const brokerConfig: BrokerOptions = {
  ...
  contextParamsCloning: Config.CTXPARAMSCLONING || false,

  // Tracking requests and waiting for running requests before shuting down. More info: https://moleculer.services/docs/0.14/context.html#Context-tracking
  tracking: {
    // Enable feature
    enabled: Config.TRACKING_ENABLED || false,
    // Number of milliseconds to wait before shuting down the process.
    shutdownTimeout: Config.TRACKINGSHUTDOWNTIME,
  },

  // Disable built-in request & emit balancer. (Transporter must support it, as well.). More info: https://moleculer.services/docs/0.14/networking.html#Disabled-balancer
  disableBalancer: Config.BALANCER_ENABLED || false,
  ...
  tracing: {
    ...
    exporter: {
      ...
      options: {
        ...
        logger: null,
        // Using colors
        colors: Config.TRACING_COLORS || true,
        // Width of row

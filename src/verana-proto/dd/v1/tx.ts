...
function createBaseMsgAddDID(): MsgAddDID {
  return { controller: "", did: "", years: 0, deposit: 0, exp: "" };
}
...
function createBaseMsgRenewDID(): MsgRenewDID {
  return { controller: "", did: "", years: 0, deposit: 0, exp: "", created: "", modified: "" };
}
...
export const MsgRenewDID = {
  encode(message: MsgRenewDID, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.deposit !== 0) {
      writer.uint32(32).uint32(message.deposit);
    }
    if (message.exp !== "") {
      writer.uint32(42).string(message.exp);
    }
    if (message.created !== "") {
      writer.uint32(50).string(message.created);
    }
    if (message.modified !== "") {
      writer.uint32(58).string(message.modified);
    }
    return writer;
  },

...
export const BULL_JOB_NAME = {
  ...
  JOB_CHECK_NEED_CREATE_EVENT_ATTR_PARTITION: 'job:check-need-create-event-attr-partition',
  ...
  JOB_CREATE_TRANSACTION_MESSAGE_PARTITION: 'job:create-transaction-message-partition',
  ...
  JOB_CREATE_COMPOSITE_INDEX_ATTR_PARTITION: 'job:create-index-composite-attr-partition',
  CRAWL_IBC_ICS20: 'crawl:ibc-ics20',
  JOB_UPDATE_SENDER_IN_TX_MESSAGES: 'job:update-sender-in-tx-messages',
  JOB_CREATE_CONSTRAINT_IN_ATTR_PARTITION: 'job:create-constraint-in-attr-partition',
  ...
  JOB_CHECK_TRANSACTION_CONSTRAINT: 'job:check-need-create-transaction-constraint',
  JOB_CHECK_TRANSACTION_MESSAGE_CONSTRAINT: 'job:check-need-create-transaction-message-constraint',
  ...
  JOB_CREATE_TRANSACTION_MESSAGE_CONSTRAINT: 'job:create-transaction-message-constraint',

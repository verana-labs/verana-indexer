...
import {
  ...
  MsgUpdateParams as MsgUpdateParamsCO,
} from '@verana-labs/verana-types/codec/verana/co/v1/tx'
import {
...
import {
  ...
  MsgUpdateParams as MsgUpdateParamsDE,
...
import {
  ...
  MsgCreateEcosystem,
  MsgUpdateEcosystem,
  MsgUpdateParams as MsgUpdateParamsEC,
} from '@verana-labs/verana-types/codec/verana/ec/v1/tx'
import {
  MsgAddGovernanceFrameworkDocument as MsgAddGovernanceFrameworkDocumentGF,
  MsgIncreaseActiveGovernanceFrameworkVersion as MsgIncreaseActiveGovernanceFrameworkVersionGF,
  MsgUpdateParams as MsgUpdateParamsGF,
...
import {
  ...
  MsgUpdateParams as MsgUpdateParamsXR,
} from '@verana-labs/verana-types/codec/verana/xr/v1/tx'
import {
...
export const veranaRegistry: readonly [string, TsProtoGeneratedType][] = [
  ...
  [
    ...
    MsgIncreaseActiveGovernanceFrameworkVersionGF,
  ],

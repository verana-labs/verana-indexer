...
export async function getModuleParams(module: string, blockHeight?: number): Promise<{ params: any } | null> {
  try {
...
export async function getModuleParamsAction(ctx: Context, module: string, moduleName: string): Promise<any> {
  try {

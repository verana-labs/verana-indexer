...
export type ParticipantState = 'ACTIVE' | 'FUTURE' | 'INACTIVE' | 'EXPIRED' | 'REVOKED' | 'SLASHED' | 'REPAID'

/** Role a Participant plays in an Ecosystem (VPR `Participant.role`). */
export type ParticipantRole = 'HOLDER' | 'ISSUER' | 'VERIFIER' | 'ISSUER_GRANTOR' | 'VERIFIER_GRANTOR' | 'ECOSYSTEM'
